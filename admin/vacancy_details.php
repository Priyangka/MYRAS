...
$sql_infos= "SELECT * FROM company WHERE  id='".$company_id ."'";
$result_infos = mysqli_query($db,$sql_infos);
$rowsInfos = mysqli_fetch_array($result_infos);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <section class="content">
	  ...
	  <div class="col-xs-12">
		  ...
		  <div class="col-md-12 ">
			...
			<h6 class="card-title"><?php echo "<a href=\"company_details.php?vacancy_id=".$rowsInfo['company_id']."\" >".$rowsInfos['title']."</a>";?></h6>
			</div>
