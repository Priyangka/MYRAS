          ...
          <div class="box box-warning">
			...
			<div id="table-container">
				   <?php 
						...
						echo "<td><a href=\"company_details.php?vacancy_id=".$rs['id']."\" class='product-title'>"; echo $rs['title']; echo"</td>";
						echo "<td>"; echo $rs['industry']; echo"</td>";
						echo "<td>"; echo $rs['ssm_no']; echo"</td>";
						echo "<td>"; echo $rs['comp_address']; echo"</td>";
