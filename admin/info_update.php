...
if(isset($_POST['submit'])){
 ...
 if( in_array($imageFileType,$extensions_arr) ){
  ...
  // Insert record
  	 $query = "UPDATE latest_information SET date='$date', title = '$title', description='$description', chk='$chk', time_from='$time_from', time_to='$time_to',
	venue='$venue', image_banner='$actual_image_name' WHERE id='$id'";
