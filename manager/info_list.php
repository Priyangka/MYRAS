      ...
      <div class="row">
        <div class="col-xs-12">
              ...
              <div class="box-header with-border">
				...
				<h3 class="box-title pull-right"><?php if($row['level']=='admin'){echo "<a href='add_info.php' id='adds'> <i class='fa fa-plus-square fa-fw'></i></a>";} ?></h3>
              </div>
	
              <div class="box-body">
             <?php
			 $now = date("m/d/Y");
			 $sqlv = "SELECT * FROM latest_information ORDER BY date desc" ;
			...
			<!--<div class="box box-danger">
			 ...
			 /*$result3 = mysqli_query($db,$sqlv);
				...
				while(($rs=mysqli_fetch_assoc($result3)))
				{
					...
					echo"</a>";
					if($row['level']=='user'){
					echo"<a href=\"info_details.php?info_id=".$rs['id']."\" class='product-title'><span class='glyphicon glyphicon-info-sign pull-right' id='adds'></a></span>";}
                    if($row['level']=='admin'){
					echo"<a href=\"delete_info.php?info_id=".$rs['id']."\" class='product-title' id='adds'><span class='glyphicon glyphicon-remove-sign pull-right' id='adds'></a></span>";}
					echo"<span class='product-description'>";
					echo $rs['date'];
					echo"</span><span class='product-description'>";
					echo $rs['preference'];
          ...
          <!-- /.box -->
			<div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">Previous Courses</h3> 
            </a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
