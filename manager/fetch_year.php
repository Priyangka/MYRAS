...
<?php 
						...
						<button id="exportButton" type="button" class="btn btn-warning exportButton"><span class="fa fa-file-excel-o"></span> Export to Excel</button>	
						...
						echo "<td>"; echo $rs['preference']; echo"</td>";
						echo "<td><a id='adds' href='delete_info.php?info_id=".$rs['id']."'><i class='fa fa-trash'></i></a></td>";     
						echo'
						';}}}}
						echo'</tbody>
							</table></div></div></div>';
