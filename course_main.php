...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	<section class="content-header">
		<h3>
          <b>GCP- Global Certification Program : Courses</b>
          <br/>
        </h3>
    </section>
		   ...
		   <div class="card sticky-top" >
			...
			<h5 class="card-title"> <i class="fa fa-newspaper-o"></i> Course</h5>
		   ...
		   <div class="box-body box-profile">
                ...
                <li class='item'>";
					...
					echo $string;
					echo '</p>';
					echo "<a href=\"info_details.php?info_id=".$rss['id']."\" class='btn btn-warning card-link'>View Info</a>";
                    echo "</p>
                    </li>
				    </ul>"; 
			       echo '</div></div>';				
		   ...
		   <div class="card sticky-top" >
			...
			<h5 class="card-title"> <i class="fa fa-newspaper-o"></i> Enroll</h5>
			<p><h6 class="card-subtitle mb-2 text-muted">This is masterlist of all courses held by organizer</h6></p>
			</div>
			<div class="box-body box-profile">
			<?php
