  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="col-md-10 col-md-offset-1">
	   ...
	   echo "<img class='img-thumbnail img-responsive center-block' alt='Program Banner' id='blah' src='admin/banner/".$rowsInfo['image_banner']."' style='width:1200px; height:400px;'/><p></p>";}
		?>
