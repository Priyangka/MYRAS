            ...
            <div class="box-header with-border">';         
				    ...
				    echo '<h3 class="box-title">Registration Form</div>';
					 echo "<div class='box-body'>
						...
						<div class='col-sm-4'>";
						echo '<input type="text" name="name" id="name" class="form-control" value="'.$row['name'].'"></div></div>';
		
					echo"<div class='form-group'>
					    <label for='inputEmail3' class='col-sm-2 control-label'>Phone Number</label>
						<div class='col-sm-4'>";
					echo '<input type="text" name="phone" id="phone" class="form-control" value="'  . htmlspecialchars($row['phone']) . '"></div></div>'; 
					
					echo"<div class='form-group'>
					    <label for='inputEmail3' class='col-sm-2 control-label'>Email</label>
						<div class='col-sm-4'>";
					echo '<input type="text" name="email" id="email" class="form-control" value="' .htmlspecialchars($row['email']). '"></div></div>'; 

					
					echo '<input type="hidden" name="no" id="no" class="form-control" value="' .htmlspecialchars($no). '">'; 
					echo '<input type="hidden" name="vacancy_id" id="vacancy_id" class="form-control" value="' . htmlspecialchars($rowsInfo1['id']) . '">'; 
					echo '<input type="hidden" name="position" id="position" class="form-control" value="' . htmlspecialchars($rowsInfo1['position']) . '">'; 
				echo '
				<div class="form-group">
                ...
                <div class="box-footer">
			  				...
			  				echo '<button type="submit" class="col-sm-6 btn btn-warning">Apply Now</button>';
